            ...
            <div className="content-container">
                ...
                <div className="chumer-text-image">
                    <div>
                        ...
                        <div>
                            <h5 className="smallblock-text"> Senate minority leader criticized</h5>
                            <h5 className="smallblock-text"> the White House for its handling</h5>
                            <h5 className="smallblock-text"> of the impeachmnt inquiry.</h5>
                            <h5 className="smallblock-text"> saying 'trails have witnesses'</h5>
                        </div>
